  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-teal-950 via-cyan-900 to-slate-900 text-white rounded-3xl p-5 shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 bg-slate-900/90 backdrop-blur-md p-3.5 rounded-2xl border border-white/15 text-center shadow-md">
          <div className="flex-1 min-w-[120px] p-2.5 bg-white/10 rounded-xl border border-white/10 flex flex-col items-center justify-center">
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center space-x-1.5 whitespace-nowrap flex-shrink-0 cursor-pointer ${
                isActive
                  ...
                  : 'bg-white text-slate-800 hover:bg-slate-100 hover:text-slate-900 border border-slate-200/80'
              }`}
            >
      ...
      {activeTab === 'dashboard' && (
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <div className="flex-1 min-w-[145px] bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-200 shadow-2xs flex flex-col justify-between space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-100 shadow-2xs space-y-3">
              ...
              <div className="space-y-2.5">
                {clientUsers.slice(0, 2).map((u) => (
                  <div key={u.id} className="p-3 bg-amber-50/70 rounded-xl border border-amber-200/60 flex flex-col space-y-2.5">
                    <div className="flex items-center space-x-2.5">
                      <img src={u.avatar} alt={u.name} className="w-10 h-10 rounded-full object-cover ring-2 ring-amber-300 flex-shrink-0" />
                      <div className="min-w-0 flex-1">
                        <h4 className="text-xs font-bold text-slate-900 leading-snug">{u.name}</h4>
                        <p className="text-[10px] text-amber-800 font-medium leading-tight mt-0.5">Snoozed 2 times this morning • 6.2h sleep</p>
                      </div>
                    </div>
                    <div className="pt-2 border-t border-amber-200/60 flex justify-end">
                      <button
                        ...
                        className="w-full sm:w-auto px-3.5 py-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-[10px] font-bold shadow-2xs text-center"
                      >
                        Coach Now
                      </button>
                    </div>
            ...
            <div className="bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-100 shadow-2xs space-y-3">
              ...
              <div className="space-y-2.5">
                {clientUsers.map((u) => (
                  <div key={u.id} className="p-3 bg-emerald-50/70 rounded-xl border border-emerald-200/60 flex flex-col space-y-2.5">
                    <div className="flex items-center space-x-2.5">
                      <img src={u.avatar} alt={u.name} className="w-10 h-10 rounded-full object-cover ring-2 ring-emerald-300 flex-shrink-0" />
                      <div className="min-w-0 flex-1">
                        <h4 className="text-xs font-bold text-slate-900 leading-snug">{u.name}</h4>
                        <p className="text-[10px] text-emerald-800 font-medium leading-tight mt-0.5">{u.streak}d Wake Streak • 0 Snoozes</p>
                      </div>
                    </div>
                    <div className="pt-2 border-t border-emerald-200/60 flex items-center justify-between">
                      <span className="text-[10px] font-bold text-emerald-800">Weekly Status</span>
                      <span className="text-[10px] font-black text-emerald-700 bg-white px-2.5 py-1 rounded-full border border-emerald-200 shadow-2xs">
                        100% Score
                      </span>
                    </div>
                  </div>
