...
export const AlarmEngine: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 rounded-3xl p-4 sm:p-6 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10 space-y-3">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <span className="px-3 py-1 rounded-full bg-white/20 text-white text-[11px] sm:text-xs font-black uppercase tracking-wider backdrop-blur-md flex items-center space-x-1.5">
              <Brain className="w-3.5 h-3.5 text-amber-300" />
              <span>Cognitive Lock Technology</span>
            </span>
            <button
              onClick={() => triggerTestAlarm()}
              className="px-3 py-1.5 bg-amber-400 hover:bg-amber-300 text-slate-900 rounded-xl text-xs font-black shadow-md transition-all flex items-center space-x-1.5 active:scale-95"
            >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          ...
          className="py-2.5 px-3.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl text-xs font-bold shadow-md transition-all flex items-center space-x-2"
        >
