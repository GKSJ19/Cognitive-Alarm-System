...
export const UserDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'alarm' | 'challenges' | 'insights' | 'habits' | 'ai' | 'leaderboard' | 'settings'>('overview');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-4 sm:p-6 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
          <div className="space-y-2 max-w-xl">
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3">
            <div className="bg-white/10 backdrop-blur-md p-2.5 sm:p-3 rounded-2xl border border-white/15 text-center">
              <Flame className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400 mx-auto" />
              <p className="text-sm sm:text-base font-extrabold text-white mt-1">{currentUser.streak} Days</p>
              <p className="text-[9px] sm:text-xs text-slate-200 uppercase font-bold tracking-tight">Streak</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md p-2.5 sm:p-3 rounded-2xl border border-white/15 text-center">
              <Award className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400 mx-auto" />
              <p className="text-sm sm:text-base font-extrabold text-white mt-1">{currentUser.points} Pts</p>
              <p className="text-[9px] sm:text-xs text-slate-200 uppercase font-bold tracking-tight">Points</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md p-2.5 sm:p-3 rounded-2xl border border-white/15 text-center">
              <Brain className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 mx-auto" />
              <p className="text-sm sm:text-base font-extrabold text-white mt-1">92 Score</p>
              <p className="text-[9px] sm:text-xs text-slate-200 uppercase font-bold tracking-tight">Cognitive</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2.5 sm:gap-3.5">
            {/* Card 1: Accuracy */}
            <div className="flex-1 min-w-[140px] bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-200/90 shadow-2xs flex flex-col justify-between space-y-2.5">
