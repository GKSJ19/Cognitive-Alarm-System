...
const HabitStackNavigator = () => (
  <Stack.Navigator screenOptions={{ headerStyle: { backgroundColor: '#F8FAFC' }, headerTintColor: '#0F172A' }}>
    ...
    <Stack.Screen name="HabitDetails" component={HabitDetailsScreen} options={{ title: 'Habit Telemetry' }} />
  </Stack.Navigator>
);
...
const CoachUserStackNavigator = () => (
  <Stack.Navigator screenOptions={{ headerStyle: { backgroundColor: '#F8FAFC' }, headerTintColor: '#0F172A' }}>
    ...
    <Stack.Screen name="UserDetails" component={UserDetailsScreen} options={{ title: 'Client Progress' }} />
  </Stack.Navigator>
);
...
const AdminBottomTabNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen name="UserManagement" component={UserManagementScreen} options={{ title: 'Users', tabBarIcon: ({ color }) => <Avatar.Icon size={24} icon="account-multiple" color={color} style={{ backgroundColor: 'transparent' }} /> }} />
