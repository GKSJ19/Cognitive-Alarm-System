      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.header}>
            <Text style={[styles.title, { color: '#FFFFFF' }]}>Verify Email</Text>
          ...
          <View style={styles.form}>
            ...
            <AppButton onPress={handleVerify} style={styles.submitButton} buttonColor="#A58BFF" textColor="#0D0B14">
              Verify Account
            </AppButton>
            
            <AppButton mode="outlined" onPress={handleResend} style={styles.resendButton} textColor="#A58BFF">
              Resend Email
            </AppButton>
          </View>
