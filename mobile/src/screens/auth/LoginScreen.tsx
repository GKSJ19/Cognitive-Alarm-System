...
export const LoginScreen: React.FC<LoginScreenProps> = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    const passwordValidation = !password ? 'Password is required' : null;
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            >
              <Text style={{ color: '#A58BFF', fontWeight: '600' }}>
                Forgot Password?
              </Text>
            </TouchableOpacity>

            <AppButton onPress={handleLogin} style={styles.submitButton} buttonColor="#A58BFF" textColor="#0D0B14">
              Log In
            </AppButton>
          </View>
          ...
          <View style={styles.dividerContainer}>
            ...
            <Text style={[styles.dividerText, { color: theme.colors.onSurfaceVariant, backgroundColor: '#0D0B14' }]}>
              OR CONTINUE WITH
            </Text>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <Text style={{ color: '#A58BFF', fontWeight: 'bold' }}>Sign Up</Text>
            </TouchableOpacity>
          </View>
