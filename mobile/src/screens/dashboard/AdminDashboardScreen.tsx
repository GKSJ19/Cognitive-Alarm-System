    ...
    <ThemeBackground>
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          refreshControl={<RefreshControl refreshing={isLoading} onRefresh={getDashboardOverview} tintColor="#A58BFF" />}
        >
        ...
        {/* --- MANAGEMENT ACTIONS --- */}
        <Text style={[styles.sectionHeading, { color: '#0F172A' }]}>Admin Management & Messaging</Text>
        <View style={styles.actionsGrid}>
          <Button mode="contained" icon="message-text" onPress={() => navigation.navigate('ChatTab')} style={styles.actionBtn} buttonColor="#38BDF8">
            Coach DM Chat
          </Button>
          <Button mode="contained" icon="bullhorn" onPress={() => navigation.navigate('BroadcastManagement')} style={styles.actionBtn} buttonColor="#0EA5E9">
            Broadcast Alerts
          </Button>
        </View>

        <View style={styles.actionsGrid}>
          <Button mode="outlined" icon="account-multiple" onPress={() => navigation.navigate('UserManagement')} style={styles.actionBtn}>
            Manage Users
          </Button>
          <Button mode="outlined" icon="teach" onPress={() => navigation.navigate('CoachManagement')} style={styles.actionBtn}>
            Manage Coaches
          </Button>
        </View>
      </ScrollView>
