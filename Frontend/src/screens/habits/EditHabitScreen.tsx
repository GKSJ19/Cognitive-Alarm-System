...
export const EditHabitScreen: React.FC<EditHabitScreenProps> = ({ route, navigation }) => {
  const { habitId } = route.params;
  const theme = useTheme();
  const { habits, updateHabit, isLoading, error, clearError } = useHabits();
  ...
  useEffect(() => {
    ...
    if (habit) {
      ...
      setTargetDays(String(habit.target_days));
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          <Text style={[styles.title, { color: theme.colors.onBackground }]}>Edit Habit</Text>
          <Text style={[styles.subtitle, { color: theme.colors.onSurfaceVariant }]}>
            Modify your habit goals and preferences
          </Text>
        </View>
