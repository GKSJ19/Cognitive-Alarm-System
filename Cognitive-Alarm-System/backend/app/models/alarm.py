from sqlalchemy import ARRAY, Boolean, Column, Enum, ForeignKey, Integer, String, TIMESTAMP, Time, text
...
class AlarmTrigger(Base):
    ...
    snooze_count = Column(Integer, nullable=False, server_default=text("0"))
